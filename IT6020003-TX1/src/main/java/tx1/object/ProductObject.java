...
public class ProductObject {
	...
	private int product_pg_id; 
	private int product_ps_id; 
	...
	private int product_price_calc_description; 
	private String product_size; 
	private String product_name_en; 
	private int product_customer_id; 
	private int product_perspective_id;
	
	public ProductObject() {
	}

	public ProductObject(int product_id, String product_name, String product_image, int product_price,
			int product_discount_price, boolean product_enable, boolean product_delete, int product_visited,
			int product_total, int product_manager_id, String product_intro, String product_notes, String product_code,
			String product_created_date, String product_modified_date, int product_pc_id, int product_pg_id,
			int product_ps_id, boolean product_is_detail, String product_deleted_date, String product_deleted_author,
			int product_promotion_price, int product_sold, boolean product_best_seller, boolean product_promotion,
			int product_price_calc_description, String product_size, String product_name_en, int product_customer_id,
			int product_perspective_id) {
	...
	public int getProduct_pc_id() {
		return product_pc_id;
	}

	public int getProduct_pg_id() {
		return product_pg_id;
	}

	public int getProduct_ps_id() {
	...
	public int getProduct_price_calc_description() {
	...
	public void setProduct_pg_id(int product_pg_id) {
		this.product_pg_id = product_pg_id;
	}

	public void setProduct_ps_id(int product_ps_id) {
		this.product_ps_id = product_ps_id;
	}
	...
	public void setProduct_price_calc_description(int product_price_calc_description) {
		this.product_price_calc_description = product_price_calc_description;
	}
